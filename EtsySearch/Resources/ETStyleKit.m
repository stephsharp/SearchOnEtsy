...
{
    //// Color Declarations
    UIColor* strokeColor = [UIColor colorWithRed: 1 green: 0.408 blue: 0.086 alpha: 1];
...
+ (void)drawShoeIconWithRect: (CGRect)rect
{
    ...
    //// Shoe
    {
        ...
        [shape2Path addLineToPoint: CGPointMake(CGRectGetMinX(shoe) + 0.17763 * CGRectGetWidth(shoe), CGRectGetMinY(shoe) + 0.55913 * CGRectGetHeight(shoe))];
        shape2Path.miterLimit = 4;
...
+ (void)drawRingIconWithRect: (CGRect)rect
{
    ...
    //// Subframes
    CGRect ring = CGRectMake(CGRectGetMinX(frame) + floor(CGRectGetWidth(frame) * 0.07692 + 0.5), CGRectGetMinY(frame) + floor(CGRectGetHeight(frame) * 0.02308 + 0.25) + 0.25, floor(CGRectGetWidth(frame) * 0.92308 + 0.5) - floor(CGRectGetWidth(frame) * 0.07692 + 0.5), floor(CGRectGetHeight(frame) * 0.97500 + 0.5) - floor(CGRectGetHeight(frame) * 0.02308 + 0.25) - 0.25);
    ...
    //// Ring
    {
        //// Shape Drawing
        UIBezierPath* shapePath = [UIBezierPath bezierPath];
        [shapePath moveToPoint: CGPointMake(CGRectGetMinX(ring) + 0.61706 * CGRectGetWidth(ring), CGRectGetMinY(ring) + 0.12430 * CGRectGetHeight(ring))];
        [shapePath addCurveToPoint: CGPointMake(CGRectGetMinX(ring) + 1.00000 * CGRectGetWidth(ring), CGRectGetMinY(ring) + 0.55556 * CGRectGetHeight(ring)) controlPoint1: CGPointMake(CGRectGetMinX(ring) + 0.83976 * CGRectGetWidth(ring), CGRectGetMinY(ring) + 0.16919 * CGRectGetHeight(ring)) controlPoint2: CGPointMake(CGRectGetMinX(ring) + 1.00000 * CGRectGetWidth(ring), CGRectGetMinY(ring) + 0.34402 * CGRectGetHeight(ring))];
        ...
        [shapePath addCurveToPoint: CGPointMake(CGRectGetMinX(ring) + 0.38509 * CGRectGetWidth(ring), CGRectGetMinY(ring) + 0.12430 * CGRectGetHeight(ring)) controlPoint1: CGPointMake(CGRectGetMinX(ring) + 0.00000 * CGRectGetWidth(ring), CGRectGetMinY(ring) + 0.34291 * CGRectGetHeight(ring)) controlPoint2: CGPointMake(CGRectGetMinX(ring) + 0.16066 * CGRectGetWidth(ring), CGRectGetMinY(ring) + 0.16803 * CGRectGetHeight(ring))];
        shapePath.miterLimit = 4;
...
+ (void)drawLampIconWithRect: (CGRect)rect
{
    ...
    //// Subframes
    CGRect lamp = CGRectMake(CGRectGetMinX(frame) + floor(CGRectGetWidth(frame) * 0.07692 + 0.5), CGRectGetMinY(frame) + floor(CGRectGetHeight(frame) * 0.02308 + 0.21) + 0.29, floor(CGRectGetWidth(frame) * 0.92308 + 0.5) - floor(CGRectGetWidth(frame) * 0.07692 + 0.5), floor(CGRectGetHeight(frame) * 0.99011 + 0.5) - floor(CGRectGetHeight(frame) * 0.02308 + 0.21) - 0.29);
...
+ (void)drawRadioIconWithRect: (CGRect)rect
{
    //// Color Declarations
    UIColor* strokeColor = [UIColor colorWithRed: 1 green: 0.408 blue: 0.086 alpha: 1];
    UIColor* fillColor = [UIColor colorWithRed: 1 green: 0.408 blue: 0.086 alpha: 1];
    ...
    //// Subframes
    CGRect radio = CGRectMake(CGRectGetMinX(frame) + floor(CGRectGetWidth(frame) * 0.01225 - 0.09) + 0.59, CGRectGetMinY(frame) + floor(CGRectGetHeight(frame) * 0.08148 - 0.28) + 0.78, floor(CGRectGetWidth(frame) * 0.98775 + 0.09) - floor(CGRectGetWidth(frame) * 0.01225 - 0.09) - 0.19, floor(CGRectGetHeight(frame) * 0.92479 + 0.09) - floor(CGRectGetHeight(frame) * 0.08148 - 0.28) - 0.37);
    ...
    //// Radio
    {
        ...
        {
            //// Oval-213 Drawing
            UIBezierPath* oval213Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.31405 - 0.33) + 0.83, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.29484 + 0.06) + 0.44, floor(CGRectGetWidth(radio) * 0.36819 - 0.19) - floor(CGRectGetWidth(radio) * 0.31405 - 0.33) - 0.13, floor(CGRectGetHeight(radio) * 0.35747 + 0.19) - floor(CGRectGetHeight(radio) * 0.29484 + 0.06) - 0.13)];
            [fillColor setFill];
            [oval213Path fill];


            //// Oval- 3 Drawing
            UIBezierPath* oval3Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.31405 - 0.33) + 0.83, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.43053 - 0.06) + 0.56, floor(CGRectGetWidth(radio) * 0.36819 - 0.19) - floor(CGRectGetWidth(radio) * 0.31405 - 0.33) - 0.13, floor(CGRectGetHeight(radio) * 0.49316 + 0.07) - floor(CGRectGetHeight(radio) * 0.43053 - 0.06) - 0.13)];
            [fillColor setFill];
            [oval3Path fill];


            //// Oval- 5 Drawing
            UIBezierPath* oval5Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.42865 + 0.14) + 0.36, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.32824 - 0.28) + 0.78, floor(CGRectGetWidth(radio) * 0.48279 + 0.27) - floor(CGRectGetWidth(radio) * 0.42865 + 0.14) - 0.13, floor(CGRectGetHeight(radio) * 0.39087 - 0.14) - floor(CGRectGetHeight(radio) * 0.32824 - 0.28) - 0.13)];
            [fillColor setFill];
            [oval5Path fill];


            //// Oval- 7 Drawing
            UIBezierPath* oval7Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.51347 + 0.38) + 0.12, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.42427 + 0.25) + 0.25, floor(CGRectGetWidth(radio) * 0.56761 - 0.48) - floor(CGRectGetWidth(radio) * 0.51347 + 0.38) + 0.87, floor(CGRectGetHeight(radio) * 0.48690 + 0.38) - floor(CGRectGetHeight(radio) * 0.42427 + 0.25) - 0.13)];
            [fillColor setFill];
            [oval7Path fill];


            //// Oval- 9 Drawing
            UIBezierPath* oval9Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.41151 + 0.32) + 0.18, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.49107 - 0.43) + 0.93, floor(CGRectGetWidth(radio) * 0.46565 + 0.45) - floor(CGRectGetWidth(radio) * 0.41151 + 0.32) - 0.13, floor(CGRectGetHeight(radio) * 0.55370 - 0.29) - floor(CGRectGetHeight(radio) * 0.49107 - 0.43) - 0.13)];
            [fillColor setFill];
            [oval9Path fill];


            //// Oval- 11 Drawing
            UIBezierPath* oval11Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.31405 - 0.33) + 0.83, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.55788 - 0.1) + 0.6, floor(CGRectGetWidth(radio) * 0.36819 - 0.19) - floor(CGRectGetWidth(radio) * 0.31405 - 0.33) - 0.13, floor(CGRectGetHeight(radio) * 0.62050 + 0.03) - floor(CGRectGetHeight(radio) * 0.55788 - 0.1) - 0.13)];
            [fillColor setFill];
            [oval11Path fill];


            //// Oval- 13 Drawing
            UIBezierPath* oval13Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.21930 - 0.31) + 0.81, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.49525 + 0.03) + 0.47, floor(CGRectGetWidth(radio) * 0.27345 - 0.18) - floor(CGRectGetWidth(radio) * 0.21930 - 0.31) - 0.13, floor(CGRectGetHeight(radio) * 0.55788 + 0.16) - floor(CGRectGetHeight(radio) * 0.49525 + 0.03) - 0.13)];
            [fillColor setFill];
            [oval13Path fill];


            //// Oval- 15 Drawing
            UIBezierPath* oval15Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.20126 - 0.02) + 0.52, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.33137 + 0.06) + 0.44, floor(CGRectGetWidth(radio) * 0.25540 + 0.11) - floor(CGRectGetWidth(radio) * 0.20126 - 0.02) - 0.13, floor(CGRectGetHeight(radio) * 0.39400 + 0.2) - floor(CGRectGetHeight(radio) * 0.33137 + 0.06) - 0.13)];
            [fillColor setFill];
            [oval15Path fill];


            //// Oval- 17 Drawing
            UIBezierPath* oval17Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.11824 - 0.49) + 0.99, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.42636 + 0.48) + 0.02, floor(CGRectGetWidth(radio) * 0.17238 - 0.36) - floor(CGRectGetWidth(radio) * 0.11824 - 0.49) - 0.13, floor(CGRectGetHeight(radio) * 0.48898 - 0.39) - floor(CGRectGetHeight(radio) * 0.42636 + 0.48) + 0.87)];
            [fillColor setFill];
            [oval17Path fill];


            //// Oval- 19 Drawing
            UIBezierPath* oval19Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.08666 - 0.49) + 0.99, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.55788 - 0.1) + 0.6, floor(CGRectGetWidth(radio) * 0.14080 - 0.36) - floor(CGRectGetWidth(radio) * 0.08666 - 0.49) - 0.13, floor(CGRectGetHeight(radio) * 0.62050 + 0.03) - floor(CGRectGetHeight(radio) * 0.55788 - 0.1) - 0.13)];
            [fillColor setFill];
            [oval19Path fill];


            //// Oval- 21 Drawing
            UIBezierPath* oval21Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.11553 - 0.15) + 0.65, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.68835 + 0.2) + 0.3, floor(CGRectGetWidth(radio) * 0.16967 - 0.02) - floor(CGRectGetWidth(radio) * 0.11553 - 0.15) - 0.13, floor(CGRectGetHeight(radio) * 0.75098 + 0.33) - floor(CGRectGetHeight(radio) * 0.68835 + 0.2) - 0.13)];
            [fillColor setFill];
            [oval21Path fill];


            //// Oval- 23 Drawing
            UIBezierPath* oval23Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.21660 + 0.03) + 0.47, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.62050 - 0.24) + 0.74, floor(CGRectGetWidth(radio) * 0.27074 + 0.17) - floor(CGRectGetWidth(radio) * 0.21660 + 0.03) - 0.13, floor(CGRectGetHeight(radio) * 0.68313 - 0.1) - floor(CGRectGetHeight(radio) * 0.62050 - 0.24) - 0.13)];
            [fillColor setFill];
            [oval23Path fill];


            //// Oval- 25 Drawing
            UIBezierPath* oval25Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.19765 + 0.44) + 0.06, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.78856 + 0.19) + 0.31, floor(CGRectGetWidth(radio) * 0.25179 - 0.43) - floor(CGRectGetWidth(radio) * 0.19765 + 0.44) + 0.87, floor(CGRectGetHeight(radio) * 0.85118 + 0.32) - floor(CGRectGetHeight(radio) * 0.78856 + 0.19) - 0.13)];
            [fillColor setFill];
            [oval25Path fill];


            //// Oval- 27 Drawing
            UIBezierPath* oval27Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.31405 - 0.33) + 0.83, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.68939 + 0.31) + 0.19, floor(CGRectGetWidth(radio) * 0.36819 - 0.19) - floor(CGRectGetWidth(radio) * 0.31405 - 0.33) - 0.13, floor(CGRectGetHeight(radio) * 0.75202 + 0.45) - floor(CGRectGetHeight(radio) * 0.68939 + 0.31) - 0.13)];
            [fillColor setFill];
            [oval27Path fill];


            //// Oval- 29 Drawing
            UIBezierPath* oval29Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.31405 - 0.33) + 0.83, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.82509 + 0.19) + 0.31, floor(CGRectGetWidth(radio) * 0.36819 - 0.19) - floor(CGRectGetWidth(radio) * 0.31405 - 0.33) - 0.13, floor(CGRectGetHeight(radio) * 0.88772 + 0.32) - floor(CGRectGetHeight(radio) * 0.82509 + 0.19) - 0.13)];
            [fillColor setFill];
            [oval29Path fill];


            //// Oval- 31 Drawing
            UIBezierPath* oval31Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.41421 - 0.03) + 0.53, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.62468 + 0.22) + 0.28, floor(CGRectGetWidth(radio) * 0.46835 + 0.11) - floor(CGRectGetWidth(radio) * 0.41421 - 0.03) - 0.13, floor(CGRectGetHeight(radio) * 0.68731 + 0.35) - floor(CGRectGetHeight(radio) * 0.62468 + 0.22) - 0.13)];
            [fillColor setFill];
            [oval31Path fill];


            //// Oval- 33 Drawing
            UIBezierPath* oval33Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.51528 + 0.16) + 0.34, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.69253 - 0.34) + 0.84, floor(CGRectGetWidth(radio) * 0.56942 + 0.29) - floor(CGRectGetWidth(radio) * 0.51528 + 0.16) - 0.13, floor(CGRectGetHeight(radio) * 0.75515 - 0.21) - floor(CGRectGetHeight(radio) * 0.69253 - 0.34) - 0.13)];
            [fillColor setFill];
            [oval33Path fill];


            //// Oval- 35 Drawing
            UIBezierPath* oval35Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.43045 - 0.09) + 0.59, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.79169 - 0.47) + 0.97, floor(CGRectGetWidth(radio) * 0.48460 + 0.05) - floor(CGRectGetWidth(radio) * 0.43045 - 0.09) - 0.13, floor(CGRectGetHeight(radio) * 0.85431 - 0.34) - floor(CGRectGetHeight(radio) * 0.79169 - 0.47) - 0.13)];
            [fillColor setFill];
            [oval35Path fill];


            //// Oval- 37 Drawing
            UIBezierPath* oval37Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.54596 + 0.26) + 0.24, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.55788 - 0.1) + 0.6, floor(CGRectGetWidth(radio) * 0.60010 + 0.4) - floor(CGRectGetWidth(radio) * 0.54596 + 0.26) - 0.13, floor(CGRectGetHeight(radio) * 0.62050 + 0.03) - floor(CGRectGetHeight(radio) * 0.55788 - 0.1) - 0.13)];
            [fillColor setFill];
            [oval37Path fill];
        }
        ...
        //// Oval- 39 Drawing
        UIBezierPath* oval39Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.77103 - 0.28) + 0.78, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.34054 + 0.43) + 0.07, floor(CGRectGetWidth(radio) * 0.88318 - 0.5) - floor(CGRectGetWidth(radio) * 0.77103 - 0.28) + 0.22, floor(CGRectGetHeight(radio) * 0.47027 + 0.2) - floor(CGRectGetHeight(radio) * 0.34054 + 0.43) + 0.22)];
        [strokeColor setStroke];
        ...
        //// Oval- 41 Drawing
        UIBezierPath* oval41Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.77103 - 0.28) + 0.78, CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.51351 + 0.39) + 0.11, floor(CGRectGetWidth(radio) * 0.88318 - 0.5) - floor(CGRectGetWidth(radio) * 0.77103 - 0.28) + 0.22, floor(CGRectGetHeight(radio) * 0.64324 + 0.17) - floor(CGRectGetHeight(radio) * 0.51351 + 0.39) + 0.22)];
        [strokeColor setStroke];
        oval41Path.lineWidth = 2;
        [oval41Path stroke];


        //// Line Drawing
        UIBezierPath* linePath = [UIBezierPath bezierPath];
        [linePath moveToPoint: CGPointMake(CGRectGetMinX(radio) + 0.87062 * CGRectGetWidth(radio), CGRectGetMinY(radio) + 0.20439 * CGRectGetHeight(radio))];
        [linePath addLineToPoint: CGPointMake(CGRectGetMinX(radio) + 0.08411 * CGRectGetWidth(radio), CGRectGetMinY(radio) + 0.00000 * CGRectGetHeight(radio))];
        linePath.miterLimit = 4;
        ...
        //// Rectangle-169 Drawing
        UIBezierPath* rectangle169Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(CGRectGetMinX(radio) + floor(CGRectGetWidth(radio) * 0.00000 + 0.5), CGRectGetMinY(radio) + floor(CGRectGetHeight(radio) * 0.20541 + 0.5), floor(CGRectGetWidth(radio) * 1.00000 - 0.31) - floor(CGRectGetWidth(radio) * 0.00000 + 0.5) + 0.81, floor(CGRectGetHeight(radio) * 1.00000 + 0.39) - floor(CGRectGetHeight(radio) * 0.20541 + 0.5) + 0.11) cornerRadius: 6];
        [strokeColor setStroke];
        rectangle169Path.lineWidth = 2;
        [rectangle169Path stroke];
    }
}
...
+ (void)drawCoatIconWithRect: (CGRect)rect
{
    ...
    //// Coat
    {
        ...
        [shapePath addCurveToPoint: CGPointMake(CGRectGetMinX(coat) + 0.77485 * CGRectGetWidth(coat), CGRectGetMinY(coat) + 0.09927 * CGRectGetHeight(coat)) controlPoint1: CGPointMake(CGRectGetMinX(coat) + 0.87331 * CGRectGetWidth(coat), CGRectGetMinY(coat) + 0.15204 * CGRectGetHeight(coat)) controlPoint2: CGPointMake(CGRectGetMinX(coat) + 0.77485 * CGRectGetWidth(coat), CGRectGetMinY(coat) + 0.09927 * CGRectGetHeight(coat))];
        shapePath.miterLimit = 4;
        ...
        [shape2Path addCurveToPoint: CGPointMake(CGRectGetMinX(coat) + 0.22574 * CGRectGetWidth(coat), CGRectGetMinY(coat) + 0.09909 * CGRectGetHeight(coat)) controlPoint1: CGPointMake(CGRectGetMinX(coat) + 0.12669 * CGRectGetWidth(coat), CGRectGetMinY(coat) + 0.15204 * CGRectGetHeight(coat)) controlPoint2: CGPointMake(CGRectGetMinX(coat) + 0.22574 * CGRectGetWidth(coat), CGRectGetMinY(coat) + 0.09909 * CGRectGetHeight(coat))];
        shape2Path.miterLimit = 4;
        ...
        //// Shape 4 Drawing
        UIBezierPath* shape4Path = [UIBezierPath bezierPath];
        [shape4Path moveToPoint: CGPointMake(CGRectGetMinX(coat) + 0.37891 * CGRectGetWidth(coat), CGRectGetMinY(coat) + 0.01622 * CGRectGetHeight(coat))];
        [shape4Path addCurveToPoint: CGPointMake(CGRectGetMinX(coat) + 0.50000 * CGRectGetWidth(coat), CGRectGetMinY(coat) + 0.00000 * CGRectGetHeight(coat)) controlPoint1: CGPointMake(CGRectGetMinX(coat) + 0.37891 * CGRectGetWidth(coat), CGRectGetMinY(coat) + 0.01622 * CGRectGetHeight(coat)) controlPoint2: CGPointMake(CGRectGetMinX(coat) + 0.41917 * CGRectGetWidth(coat), CGRectGetMinY(coat) + 0.00000 * CGRectGetHeight(coat))];
        [shape4Path addCurveToPoint: CGPointMake(CGRectGetMinX(coat) + 0.62090 * CGRectGetWidth(coat), CGRectGetMinY(coat) + 0.01622 * CGRectGetHeight(coat)) controlPoint1: CGPointMake(CGRectGetMinX(coat) + 0.58083 * CGRectGetWidth(coat), CGRectGetMinY(coat) + 0.00000 * CGRectGetHeight(coat)) controlPoint2: CGPointMake(CGRectGetMinX(coat) + 0.62090 * CGRectGetWidth(coat), CGRectGetMinY(coat) + 0.01622 * CGRectGetHeight(coat))];
        shape4Path.miterLimit = 4;
...
+ (void)drawKnittingIconWithRect: (CGRect)rect
{
    ...
    //// Knitting
    {
        //// Layer_1
        {
            ...
            //// Shape 4 Drawing
            UIBezierPath* shape4Path = [UIBezierPath bezierPath];
            [shape4Path moveToPoint: CGPointMake(CGRectGetMinX(knitting) + 0.66139 * CGRectGetWidth(knitting), CGRectGetMinY(knitting) + 0.32417 * CGRectGetHeight(knitting))];
            [shape4Path addCurveToPoint: CGPointMake(CGRectGetMinX(knitting) + 0.68182 * CGRectGetWidth(knitting), CGRectGetMinY(knitting) + 0.46139 * CGRectGetHeight(knitting)) controlPoint1: CGPointMake(CGRectGetMinX(knitting) + 0.67466 * CGRectGetWidth(knitting), CGRectGetMinY(knitting) + 0.36752 * CGRectGetHeight(knitting)) controlPoint2: CGPointMake(CGRectGetMinX(knitting) + 0.68182 * CGRectGetWidth(knitting), CGRectGetMinY(knitting) + 0.41361 * CGRectGetHeight(knitting))];
            ...
            [shape8Path moveToPoint: CGPointMake(CGRectGetMinX(knitting) + 0.56563 * CGRectGetWidth(knitting), CGRectGetMinY(knitting) + 0.04666 * CGRectGetHeight(knitting))];
            [shape8Path addCurveToPoint: CGPointMake(CGRectGetMinX(knitting) + 0.15909 * CGRectGetWidth(knitting), CGRectGetMinY(knitting) + 0.50753 * CGRectGetHeight(knitting)) controlPoint1: CGPointMake(CGRectGetMinX(knitting) + 0.33307 * CGRectGetWidth(knitting), CGRectGetMinY(knitting) + 0.07501 * CGRectGetHeight(knitting)) controlPoint2: CGPointMake(CGRectGetMinX(knitting) + 0.15909 * CGRectGetWidth(knitting), CGRectGetMinY(knitting) + 0.27224 * CGRectGetHeight(knitting))];
            ...
            //// Line Drawing
            UIBezierPath* linePath = [UIBezierPath bezierPath];
            [linePath moveToPoint: CGPointMake(CGRectGetMinX(knitting) + 0.17136 * CGRectGetWidth(knitting), CGRectGetMinY(knitting) + 0.84373 * CGRectGetHeight(knitting))];
            ...
            //// Line 2 Drawing
            UIBezierPath* line2Path = [UIBezierPath bezierPath];
            [line2Path moveToPoint: CGPointMake(CGRectGetMinX(knitting) + 0.74400 * CGRectGetWidth(knitting), CGRectGetMinY(knitting) + 0.75106 * CGRectGetHeight(knitting))];
...
+ (void)drawWatchIconWithRect: (CGRect)rect
{
    ...
    //// Watch
    {
        ...
        [rectangle168Path moveToPoint: CGPointMake(CGRectGetMinX(watch) + 0.43245 * CGRectGetWidth(watch), CGRectGetMinY(watch) + 0.83816 * CGRectGetHeight(watch))];
        ...
        [rectangle168Path moveToPoint: CGPointMake(CGRectGetMinX(watch) + 0.52236 * CGRectGetWidth(watch), CGRectGetMinY(watch) + 0.20756 * CGRectGetHeight(watch))];
        ...
        [rectangle168Path addLineToPoint: CGPointMake(CGRectGetMinX(watch) + 0.78024 * CGRectGetWidth(watch), CGRectGetMinY(watch) + 0.49019 * CGRectGetHeight(watch))];
...
+ (void)drawDressIconWithRect: (CGRect)rect
{
    ...
    //// Dress
    {
        ...
        //// Shape 5 Drawing
        UIBezierPath* shape5Path = [UIBezierPath bezierPath];
        [shape5Path moveToPoint: CGPointMake(CGRectGetMinX(dress) + 0.22727 * CGRectGetWidth(dress), CGRectGetMinY(dress) + 0.93299 * CGRectGetHeight(dress))];
        [shape5Path addCurveToPoint: CGPointMake(CGRectGetMinX(dress) + 0.31818 * CGRectGetWidth(dress), CGRectGetMinY(dress) + 0.63154 * CGRectGetHeight(dress)) controlPoint1: CGPointMake(CGRectGetMinX(dress) + 0.22727 * CGRectGetWidth(dress), CGRectGetMinY(dress) + 0.77915 * CGRectGetHeight(dress)) controlPoint2: CGPointMake(CGRectGetMinX(dress) + 0.31818 * CGRectGetWidth(dress), CGRectGetMinY(dress) + 0.63154 * CGRectGetHeight(dress))];
        shape5Path.miterLimit = 4;
...
+ (void)drawBuffetIconWithRect: (CGRect)rect
{
    ...
    //// Buffet
    {
        ...
        //// Oval 2 Drawing
        UIBezierPath* oval2Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(buffet) + floor(CGRectGetWidth(buffet) * 0.75000 - 0.5) + 1, CGRectGetMinY(buffet) + floor(CGRectGetHeight(buffet) * 0.34615 - 0.24) + 0.74, floor(CGRectGetWidth(buffet) * 0.79545 - 0.32) - floor(CGRectGetWidth(buffet) * 0.75000 - 0.5) - 0.18, floor(CGRectGetHeight(buffet) * 0.42308 - 0.07) - floor(CGRectGetHeight(buffet) * 0.34615 - 0.24) - 0.17)];
        [fillColor setFill];
        [oval2Path fill];


        //// Oval 4 Drawing
        UIBezierPath* oval4Path = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(buffet) + floor(CGRectGetWidth(buffet) * 0.20455 + 0.32) + 0.18, CGRectGetMinY(buffet) + floor(CGRectGetHeight(buffet) * 0.34615 - 0.24) + 0.74, floor(CGRectGetWidth(buffet) * 0.25000 + 0.5) - floor(CGRectGetWidth(buffet) * 0.20455 + 0.32) - 0.18, floor(CGRectGetHeight(buffet) * 0.42308 - 0.07) - floor(CGRectGetHeight(buffet) * 0.34615 - 0.24) - 0.17)];
        [fillColor setFill];
        [oval4Path fill];
        ...
        //// Shape 5 Drawing
        UIBezierPath* shape5Path = [UIBezierPath bezierPath];
        [shape5Path moveToPoint: CGPointMake(CGRectGetMinX(buffet) + 0.93182 * CGRectGetWidth(buffet), CGRectGetMinY(buffet) + 1.00000 * CGRectGetHeight(buffet))];
        ...
        [shape5Path addLineToPoint: CGPointMake(CGRectGetMinX(buffet) + 0.90909 * CGRectGetWidth(buffet), CGRectGetMinY(buffet) + 0.76923 * CGRectGetHeight(buffet))];
        ...
        //// Shape 6 Drawing
        UIBezierPath* shape6Path = [UIBezierPath bezierPath];
        [shape6Path moveToPoint: CGPointMake(CGRectGetMinX(buffet) + 0.06818 * CGRectGetWidth(buffet), CGRectGetMinY(buffet) + 1.00000 * CGRectGetHeight(buffet))];
        ...
        [shape6Path addLineToPoint: CGPointMake(CGRectGetMinX(buffet) + 0.09091 * CGRectGetWidth(buffet), CGRectGetMinY(buffet) + 0.76923 * CGRectGetHeight(buffet))];
...
+ (void)drawBowtieIconWithRect: (CGRect)rect
{
    ...
    //// Bowtie
    {
        ...
        //// Shape 2 Drawing
        UIBezierPath* shape2Path = [UIBezierPath bezierPath];
        [shape2Path moveToPoint: CGPointMake(CGRectGetMinX(bowtie) + 0.60417 * CGRectGetWidth(bowtie), CGRectGetMinY(bowtie) + 0.71429 * CGRectGetHeight(bowtie))];
        [shape2Path addCurveToPoint: CGPointMake(CGRectGetMinX(bowtie) + 0.95833 * CGRectGetWidth(bowtie), CGRectGetMinY(bowtie) + 1.00000 * CGRectGetHeight(bowtie)) controlPoint1: CGPointMake(CGRectGetMinX(bowtie) + 0.73696 * CGRectGetWidth(bowtie), CGRectGetMinY(bowtie) + 0.94193 * CGRectGetHeight(bowtie)) controlPoint2: CGPointMake(CGRectGetMinX(bowtie) + 0.95833 * CGRectGetWidth(bowtie), CGRectGetMinY(bowtie) + 1.00000 * CGRectGetHeight(bowtie))];
        ...
        [shape2Path addCurveToPoint: CGPointMake(CGRectGetMinX(bowtie) + 0.60417 * CGRectGetWidth(bowtie), CGRectGetMinY(bowtie) + 0.28571 * CGRectGetHeight(bowtie)) controlPoint1: CGPointMake(CGRectGetMinX(bowtie) + 0.95833 * CGRectGetWidth(bowtie), CGRectGetMinY(bowtie) + 0.00000 * CGRectGetHeight(bowtie)) controlPoint2: CGPointMake(CGRectGetMinX(bowtie) + 0.71342 * CGRectGetWidth(bowtie), CGRectGetMinY(bowtie) + 0.09843 * CGRectGetHeight(bowtie))];
        shape2Path.miterLimit = 4;
        ...
        //// Shape 5 Drawing
        UIBezierPath* shape5Path = [UIBezierPath bezierPath];
        [shape5Path moveToPoint: CGPointMake(CGRectGetMinX(bowtie) + 0.39583 * CGRectGetWidth(bowtie), CGRectGetMinY(bowtie) + 0.71429 * CGRectGetHeight(bowtie))];
        [shape5Path addCurveToPoint: CGPointMake(CGRectGetMinX(bowtie) + 0.04167 * CGRectGetWidth(bowtie), CGRectGetMinY(bowtie) + 1.00000 * CGRectGetHeight(bowtie)) controlPoint1: CGPointMake(CGRectGetMinX(bowtie) + 0.26304 * CGRectGetWidth(bowtie), CGRectGetMinY(bowtie) + 0.94193 * CGRectGetHeight(bowtie)) controlPoint2: CGPointMake(CGRectGetMinX(bowtie) + 0.04167 * CGRectGetWidth(bowtie), CGRectGetMinY(bowtie) + 1.00000 * CGRectGetHeight(bowtie))];
        ...
        [shape5Path addCurveToPoint: CGPointMake(CGRectGetMinX(bowtie) + 0.39583 * CGRectGetWidth(bowtie), CGRectGetMinY(bowtie) + 0.28571 * CGRectGetHeight(bowtie)) controlPoint1: CGPointMake(CGRectGetMinX(bowtie) + 0.04167 * CGRectGetWidth(bowtie), CGRectGetMinY(bowtie) + 0.00000 * CGRectGetHeight(bowtie)) controlPoint2: CGPointMake(CGRectGetMinX(bowtie) + 0.28658 * CGRectGetWidth(bowtie), CGRectGetMinY(bowtie) + 0.09843 * CGRectGetHeight(bowtie))];
        shape5Path.miterLimit = 4;
